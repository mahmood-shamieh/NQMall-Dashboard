...
import 'package:nq_mall_dashboard/controllers/brand/edit_brand_screen_controller.dart';
...
class EditBrandScreen extends StatelessWidget {
  ...
  EditBrandScreen({super.key, required this.brandModel});

  @override
  Widget build(BuildContext context) {
    // return Container();
    return GetBuilder<EditBrandScreenController>(
      init: Get.put(EditBrandScreenController(brandModel: brandModel)),
